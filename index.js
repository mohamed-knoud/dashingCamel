...
const client = new smartcar.AuthClient({
  ...
  redirectUri: 'https://javascript-sdk.smartcar.com/v2/redirect?app_origin=https://dashing-camel.vercel.app:3000', // fallback to SMARTCAR_REDIRECT_URI ENV variable
